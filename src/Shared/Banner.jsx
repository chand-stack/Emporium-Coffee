...
const Banner = () => {
    return (
        <div className='lg:h-screen md:flex justify-end p-2 md:p-4 lg:p-0  text-white' style={{backgroundImage:`url(${banner})`,backgroundSize:"cover",backgroundRepeat:"no-repeat"}}>
            ...
            <h1 className='font-normal text-3xl md:text-6xl text-white font-Rancho'>Would you like a Cup of Delicious Coffee?</h1>
            ...
            <button className='text-[#242222] md:text-2xl bg-[#E3B577] font-Rancho btn rounded-none border-none'>Learn More</button>
            </div>
            </div>
