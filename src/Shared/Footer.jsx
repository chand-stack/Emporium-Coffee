    ...
    return (
        <div className='w-full mt-10 text-[#331A15]' style={{backgroundImage:`url(${bg})`, backgroundRepeat:"no-repeat",backgroundSize:"cover"}}>
            ...
            <div className='space-y-4'>
             ...
             <h1 className='text-5xl text-[#331A15] font-Rancho'>Espresso Emporium</h1>
             ...
             <p className='text-5xl text-[#331A15] font-Rancho'>Get in Touch</p>
...
<h1 className='text-5xl text-[#331A15] font-Rancho'>Connect with Us</h1>
...
<button className="btn btn-outline rounded-full text-[#331A15] font-Rancho">Send Message</button>
...
<footer className="footer footer-center p-4 text-base-content bg-black bg-opacity-50" >
  <aside>
    <p className='text-white text-xl font-Rancho'>Copyright Espresso Emporium ! All Rights Reserved</p>
  </aside>
</footer>
</div>
