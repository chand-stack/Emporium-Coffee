...
const Coffees = () => {
    return (
        <div className='mt-28 space-y-4' style={{backgroundImage:`url(${bg})`,backgroundRepeat:"no-repeat"}}>
            ...
            <button className='btn bg-[#E3B577] border-2 border-[#331A15]'><span className='flex items-center gap-3 text-white'>Add Coffee <GiCoffeeCup className='text-[#331A15]'/></span></button>
            </div>
        </div>
    );
};
