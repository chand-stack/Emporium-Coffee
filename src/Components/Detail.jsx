...
<Link to="/"><p className='lg:text-4xl  md:px-0 md:mx-32 md:text-2xl flex items-center font-Rancho gap-3 py-12'><BsArrowLeft/> Back To Home</p></Link>
...
<div className="lg:flex justify-around items-center">
    ...
    <div className="space-y-2">
        <p className="text-[#331A15] text-4xl font-Rancho my-4">Niceties</p>
